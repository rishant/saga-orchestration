...
public class OrderService {
    ...
    // product price map
    private static final Map<Integer, Double> PRODUCT_PRICE =  getProductPrices();

	public static Map<Integer, Double> getProductPrices() {
		Map<Integer, Double> productPrices = new HashMap<>();
		productPrices.put(1, 100d);
		productPrices.put(2, 200d);
		productPrices.put(3, 300d);
